...
authorizationRouter.delete('/account/user/:login', authorization.hasRole(ADMIN, 'login'))
authorizationRouter.patch('/account/user/:login', authorization.hasRole(null, 'login'))
// authorizationRouter.post('/forum/post/:author', authorization.hasRole(null, 'author'))
// authorizationRouter.delete('/forum/post/:id', authorization.hasRole(MODERATOR, 'author'))
